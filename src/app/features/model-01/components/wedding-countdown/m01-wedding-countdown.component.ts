...
@Component({
  selector: 'app-m01-wedding-countdown',
  standalone: true,
  imports: [LottieComponent],
  templateUrl: './m01-wedding-countdown.component.html',
  styleUrl: './m01-wedding-countdown.component.css',
})
export class M01WeddingCountdownComponent implements OnInit, OnDestroy {
